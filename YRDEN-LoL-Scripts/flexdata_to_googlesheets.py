...
df = df.select([pl.col('teamid'), pl.col('game_creation').cast(pl.String), pl.col('Yrden Flag'), pl.col('riot_id'), pl.col('champion_name'), pl.col('lane'), pl.col('win'), pl.col('kills'), pl.col('deaths'), pl.col('assists'), pl.col('KDA'),
